...
describe('useCart Hook', () => {
  beforeEach(() => {
    ...
    vi.spyOn(Storage.prototype, 'getItem').mockReturnValueOnce(JSON.stringify(initialStoredData));
  });
  ...
  it('should not be able add a product that does not exist', async () => {
    ...
    expect(result.current.cart).toEqual(expect.arrayContaining(initialStoredData));
